...
import litellm
from tools.fs.fs import list_directory_contents, get_path_details, read_file_contents
...
computron_agent = LlmAgent(
    name="COMPUTRON_9000",
    model=LiteLlm(
        model="ollama_chat/qwen2.5-coder:32b_num_ctx_32768", 
    ),
    description=(
    ...
    tools=[list_directory_contents, get_path_details, read_file_contents],
)
