"""Gating Verifier agent: decides whether a step advances based on execution report.

Consumes assignment (instructions), coder_output summary, test_plan JSON, and
execution_report (VerificationReport JSON). Returns VerifierDecision strict JSON.
"""
